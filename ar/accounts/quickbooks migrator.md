...
-**الفاتورة**تعادل فاتورة المبيعات.
-**إيصال المبيعات**يعادل فاتورة مبيعات نقطة البيع.
-**مذكرة الائتمان**تعادل فاتورة المبيعات المرتجعة (ملاحظة دائنة).
-**إيصال الاسترداد**يعادل فاتورة مبيعات نقاط البيع المرتجعة.
""
...
-**الفاتورة**تعادل فاتورة الشراء.
-**ائتمان المورد**يعادل فاتورة الشراء المرتجعة.
""
