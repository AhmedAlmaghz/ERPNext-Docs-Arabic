...
![Item With Deferred Expense](https://docs.erpnext.com/files/deferred-item-expense.png)
...
![Invoice With Deferred Expense](https://docs.erpnext.com/files/deferred-purchase-invoice.gif)
