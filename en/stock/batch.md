...
*   Enable 'Has Batch No' in the Item master ![Batch No Enabled](https://docs.erpnext.com/files/batch-no-enabled.png)
...
When Batches are enabled for an Item, the option to [retain sample stock](https://docs.erpnext.com/docs/v13/user/manual/en/stock/retain-sample-stock) also becomes available.
...
![Item Setup for Batches](https://docs.erpnext.com/files/item_setup_for_batch.png)
...
![Batch View](https://docs.erpnext.com/files/batch_view.png)
...
2.  [Opening Stock Balance Entry For Serialized And Batch Item](https://docs.erpnext.com/docs/v13/user/manual/en/stock/articles/opening-stock-balance-entry-for-serialized-and-batch-item)
