Items for which Serial No. and Batch No. is maintained, opening stock balance entry for them is update via Stock Entry. [Click here to learn how serialized inventory is managed in ERPNext](https://docs.erpnext.com/docs/v13/user/manual/en/stock/serial-no.html).
...
For the serialized item, mention Serial Nos. equivalent to it's Qty. Or if Serial Nos. are configured to be created based on Prefix, then no need to mention Serial Nos. manually. Click [here](https://docs.erpnext.com/docs/v13/user/manual/en/stock/articles/serial-no-naming.html) to learn more about Serial No. naming.
...
[Click here to learn how Batchwise inventory is managed in ERPNext.](https://docs.erpnext.com/docs/v13/user/manual/en/stock/articles/managing-batch-wise-inventory.html)
...
![Difference Account](https://docs.erpnext.com/files/difference-account-1.png)
