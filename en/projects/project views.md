...
![Task - Gantt View](https://docs.erpnext.com/files/task-gantt-chart.png) _Gantt Chart for Tasks_
...
If you want to further customize the chart and make it more colorful, read [this article](https://docs.erpnext.com/docs/v13/user/manual/en/projects/articles/make-a-colorful-gantt-chart)
...
![Task - Kanban View](https://docs.erpnext.com/files/task-kanban.png) _ERPNext Kanban Board_
...
Read [customizing Kanban board](https://docs.erpnext.com/docs/v13/user/manual/en/customize-erpnext/kanban-board) to learn more.
...
![Task - Calendar View](https://docs.erpnext.com/files/task-calendar.png) _Calendar View for Tasks_